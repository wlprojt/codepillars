        ...
        <Card className="rounded-[32px] border border-white/25 bg-white/10 backdrop-blur-2xl shadow-[0_30px_100px_rgba(0,0,0,0.45)] text-black">
          <CardContent className="p-6 space-y-6">
            <div className="text-center">
              <h1 className="text-2xl font-bold text-[#142342]">Welcome back</h1>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="flex justify-end">
                <Link href="/forgot-password" className="text-sm text-[#3a82e8] hover:underline">
                  Forgot password?
                </Link>
              </div>
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-12 rounded-[32px] bg-gradient-to-br from-[#d6f0ee] via-[#bed3ee] to-[#c4c4f4] backdrop-blur-md border border-white/25 text-[#142342] font-bold text-lg hover:scale-[1.02] transition-transform disabled:opacity-50"
              >
            ...
            <p className="text-center text-sm text-gray-600">
              ...
              <Link href="/register" className="text-[#3a82e8] hover:underline">
                Create one
              </Link>
            </p>
          </CardContent>
